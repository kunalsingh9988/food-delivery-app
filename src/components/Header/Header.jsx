  ...
  return (
    <div id="headerContainer">
      <div className={isBarOpen ? "header" : "header header2"}>
        ...
        <div className={isBarOpen ? "rightHeader" : "rightHeader rightHeader2"}>
          <ul>
            <li>
              <Link to="/">
                <span>Home</span>
      ...
      <div className="menu" onClick={() => setIsBarOpen(!isBarOpen)}>
        {isBarOpen ? (
          <AiOutlineClose className="menuBar" />
          ) : (
          <HiOutlineMenu className="menuBar" />
        )}
      </div>
    </div>
  );
